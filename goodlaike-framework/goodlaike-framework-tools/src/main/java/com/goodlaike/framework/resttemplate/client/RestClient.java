package com.goodlaike.framework.resttemplate.client;
...
import com.goodlaike.framework.resttemplate.utils.RestClientBuilder;
...
public class RestClient {
     ...
     */
    public static <T> T exchange(String url, HttpMethod method, Class<T> responseType, Object... uriVariables)
            throws RestClientException {
     ...
     *             RestClient异常，包含状态码和非200的返回内容
     */
    public static <T> T exchange(String url, HttpMethod method, HttpHeaders headers, Class<T> responseType,
     ...
     *             RestClient异常，包含状态码和非200的返回内容
     */
    public static <T> T exchange(String url, HttpMethod method, Object body, Class<T> responseType,
            Object... uriVariables) throws RestClientException {
     ...
     *             RestClient异常，包含状态码和非200的返回内容
     */
    public static <T> T exchange(String url, HttpMethod method, HttpHeaders httpHeaders, Object body,
     ...
     *             RestClient异常，包含状态码和非200的返回内容
     */
    public static <T> T exchange(String url, HttpMethod method, ParameterizedTypeReference<T> responseType,
            Object... uriVariables) throws RestClientException {
        return exchange(url, method, null, null, responseType, uriVariables);
    }
     ...
     *             RestClient异常，包含状态码和非200的返回内容
     */
    public static <T> T exchange(String url, HttpMethod method, HttpHeaders headers,
     ...
     *             RestClient异常，包含状态码和非200的返回内容
     */
    public static <T> T exchange(String url, HttpMethod method, Object body, ParameterizedTypeReference<T> responseType,
            Object... uriVariables) throws RestClientException {
        return exchange(url, method, null, body, responseType, uriVariables);
    }
    ...
    public static HttpHeaders buildJSONHeaders(Object... arrays) {
        ...
        for (int i = 0; i < arrays.length; i++) {
            if (arrays[i] != null)
                headers.add(String.valueOf(arrays[i]), String.valueOf(arrays[++i]));
        }
