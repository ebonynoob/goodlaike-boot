...
import com.goodlaike.framework.tools.enums.FileType;
...
public class FileUtil {
     ...
     * image 文件后缀集合
     */
    private static List<String> images = Arrays
            .asList(new String[] { "bmp", "jpg", "gif", "bmp", "jfif", "tiff", "jpe", "ico", "jpeg", "png" });
     ...
     * doc 文件后缀集合
     */
    private static List<String> docs = Arrays.asList(new String[] { "doc", "docx" });
     ...
     * xls 文件后缀集合
     */
    private static List<String> xlss = Arrays.asList(new String[] { "xls", "xlsx" });

    /**
     * video 文件后缀集合
     */
    private static List<String> videos = Arrays
            .asList(new String[] { "mp4", "flv", "dat", "mkv", "avi", "wmv", "mov" });
     ...
     * @since 1.0.0
     * @author jail
     * @createTime 2015年8月25日下午10:45:11
     * @updator jail
     * @updateTime 2015年8月25日下午10:45:11
     */
    public static String getSuffix2(String fileName) throws IOException {
