package com.goodlaike.framework.dao.utils;
...
public class TextUtil {
    ...
    public static String format(String msgModel, Object... strings) {
        for (int i = 0; i < strings.length; i++) {
            msgModel = msgModel.replaceAll("\\{" + i + "\\}", String.valueOf(strings[i]));
        }
        return msgModel;
    }

    public static String format2(String msgModel, String placeholder, String... strings) {
        for (int i = 0; i < strings.length; i++) {
            msgModel = msgModel.replaceAll(placeholder + i + placeholder, strings[i]);
        }
        return msgModel;
    }
